...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:51200'],         // 50 MB — supports high-res images and PDF catalogues
        ...
        'preview_mimes' => [                                  // Supported file types for temporary pre-signed file URLs...
            ...
            'pdf',                                            // PDF catalogue upload support
        ],
        'max_upload_time' => 10, // Max duration (in minutes) before an upload is invalidated — raised for large files
