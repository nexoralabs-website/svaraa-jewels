    ...
    >
        ...
        <div class="flex-1 overflow-y-auto px-6 py-4 space-y-6">
            <template x-if="$store.cart.items.length === 0">
                ...
                <div class="flex flex-col items-center justify-center h-full text-center py-16">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" @click="$store.cart.open = false" class="inline-block bg-[#6E0F12] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[#520b0d] transition-colors">
                        Start Shopping
                    </a>
                </div>
            </template>
        ...
        <template x-if="$store.cart.items.length > 0">
            <div class="border-t border-[#C8A35D]/20 px-6 py-5 space-y-4 bg-[#FDFBF7]">
                ...
                <div class="space-y-2">
                    <a href="<?php echo e(route('cart.index')); ?>" class="block w-full border border-[#C8A35D] text-[#C8A35D] text-center py-3 rounded-full font-medium hover:bg-[#C8A35D] hover:text-white transition-colors">
                        View Cart
                    </a>
                    <a href="<?php echo e(route('checkout.index')); ?>" class="block w-full bg-[#C8A35D] text-white text-center py-3 rounded-full font-medium hover:bg-[#b8934d] transition-colors">
                        Checkout
                    </a>
                </div>
            </div>
...
<?php /**PATH /var/www/html/resources/views/components/cart/sidebar.blade.php ENDPATH**/ ?>