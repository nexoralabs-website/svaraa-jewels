...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Register | Svaraa Jewels <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-md w-full bg-white p-10 border border-[#C8A35D]/30 shadow-xl relative">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="name" class="w-full border-gray-200 py-2.5 px-3 text-sm focus:border-[#C8A35D] focus:ring-0 outline-none border transition-colors">
...
<?php endif; ?>
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="username" class="w-full border-gray-200 py-2.5 px-3 text-sm focus:border-[#C8A35D] focus:ring-0 outline-none border transition-colors">
                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
            ...
            <div class="mt-8 text-center text-sm text-gray-600">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-[#C8A35D] hover:text-[#6E0F12] font-medium transition-colors">
                    Sign in
                </a>
            </div>
        </div>
