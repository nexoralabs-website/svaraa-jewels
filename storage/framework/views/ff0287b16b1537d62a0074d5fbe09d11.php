...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Login | Svaraa Jewels <?php $__env->endSlot(); ?>
...
<?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username" class="w-full border-gray-200 py-2.5 px-3 text-sm focus:border-[#C8A35D] focus:ring-0 outline-none border transition-colors">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-[#C8A35D] hover:text-[#6E0F12] transition-colors">
                                Forgot password?
                            </a>
...
<?php endif; ?>
            ...
            <div class="mt-8 text-center text-sm text-gray-600">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-[#C8A35D] hover:text-[#6E0F12] font-medium transition-colors">
                    Create one
                </a>
            </div>
        </div>
