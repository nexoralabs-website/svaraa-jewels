...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> <?php echo e($query ? 'Search: ' . $query : 'Search'); ?> | Svaraa Jewels <?php $__env->endSlot(); ?>

    <div class="bg-[#FDFBF7] py-10 border-b border-[#E8DCCB]/30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-3xl md:text-4xl font-serif text-[#2E1A12]">
                <?php echo e($query ? 'Results for "' . $query . '"' : 'Search'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p class="mb-8 text-sm text-gray-500 text-center">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($products->total() > 0): ?>
                <?php echo e(number_format($products->total())); ?> result<?php echo e($products->total() !== 1 ? 's' : ''); ?>

                for <strong class="text-[#2E1A12]">"<?php echo e($query); ?>"</strong>
            <?php else: ?>
                No results for <strong class="text-[#2E1A12]">"<?php echo e($query); ?>"</strong>.
            ...
            <a href="<?php echo e(route('products.show', $product->slug)); ?>"
               class="group bg-white rounded-xl border border-[#E8DCCB] overflow-hidden
                ...
                <div class="aspect-square overflow-hidden bg-gray-50">
                    <img src="<?php echo e($product->thumbnail ? asset('storage/'.$product->thumbnail) : asset('images/placeholder.jpg')); ?>"
        ...
        <div class="mt-12 border-t border-gray-100 pt-8">
            <?php echo e($products->appends(['q' => $query])->links()); ?>
    ...
    function searchPage() {
        return {
            term: '<?php echo e(addslashes($query ?? '')); ?>',
            suggestions: [],
            submitting: false,
            async fetchSuggestions() {
                if (this.term.length < 2) { this.suggestions = []; return; }
                try {
                    const res = await fetch('<?php echo e(route('search.suggest')); ?>?q=' + encodeURIComponent(this.term));
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/pages/search/index.blade.php ENDPATH**/ ?>