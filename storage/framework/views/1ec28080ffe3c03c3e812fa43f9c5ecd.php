...
<div class="page">
    ...
    <div class="header">
        ...
        <div class="invoice-title">
            <h2>Tax Invoice</h2>
            <div class="invoice-number"><?php echo e($order->invoice_number); ?></div>
    ...
    <div class="meta-grid">
        ...
        <div class="meta-box">
            ...
            <div class="meta-value"><?php echo e($order->shipping_address); ?></div>
        </div>
        <div class="meta-box">
            ...
            <div class="meta-value">
                ...
                <span class="status-badge <?php echo e($order->payment_status === 'captured' ? 'status-paid' : 'status-pending'); ?>">
                    <?php echo e($order->payment_status === 'captured' ? 'PAID' : strtoupper($order->payment_status)); ?>
    ...
    <table class="items-table">
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <tr>
    ...
    <div class="totals-wrapper">
        <div class="totals-table">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($order->coupon_discount ?? 0) > 0): ?>
            <div class="totals-row discount">
                <span class="label">Coupon (<?php echo e($order->coupon_code); ?>)</span>
                <span class="value">−₹<?php echo e(number_format($order->coupon_discount, 2)); ?></span>
            </div>
            ...
            <div class="totals-row">
                ...
                <span class="value">₹<?php echo e(number_format($order->shipping, 2)); ?></span>
            </div>
            <?php else: ?>
            <div class="totals-row">
                <span class="label">Shipping</span>
    ...
    <table class="gst-table">
        ...
        <tbody>
            <tr>
                <td>Jewellery</td>
                <td>7113</td>
                <td>₹<?php echo e(number_format($gst['taxable'], 2)); ?></td>
                <td>₹<?php echo e(number_format($gst['cgst'], 2)); ?></td>
                <td>₹<?php echo e(number_format($gst['sgst'], 2)); ?></td>
                <td>₹<?php echo e(number_format($gst['total'], 2)); ?></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="footer">
        ...
        <p><strong><?php echo e($appName); ?></strong> · <?php echo e(config('app.url')); ?> · <?php echo e(config('mail.from.address')); ?></p>
        <p>Thank you for shopping with us. For queries, contact us at <?php echo e(config('mail.from.address')); ?></p>
    </div>
