...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Forgot Password | Svaraa Jewels <?php $__env->endSlot(); ?>
...
<?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('password.email')); ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus class="w-full border-gray-200 py-2.5 px-3 text-sm focus:border-[#C8A35D] focus:ring-0 outline-none border transition-colors">
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between">
                    <a href="<?php echo e(route('login')); ?>" class="text-[#C8A35D] hover:text-[#6E0F12] text-sm font-medium transition-colors">
                        Back to Login
                    </a>
