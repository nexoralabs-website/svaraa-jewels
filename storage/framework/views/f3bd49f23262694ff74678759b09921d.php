...
<head>
    ...
    <title>Order Confirmed - <?php echo e($order->order_number); ?> | <?php echo e(config('app.name')); ?></title>
    <style>
    ...
    <div class="container">
        <div class="card">
            <div class="header">
                ...
                <p>Thank you for shopping with <?php echo e(config('app.name')); ?>. Your order has been placed successfully.</p>
            </div>
            ...
            <div class="body">
                <div class="section">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <p class="info-value"><?php echo e($order->created_at->format('F d, Y')); ?></p>
                        </div>
                        <div class="info-item">
                            ...
                            <p class="info-value">
                                ...
                                ?>
                                <span class="badge <?php echo e($statusClass); ?>"><?php echo e(ucfirst($order->payment_status)); ?></span>
                            </p>
                        </div>
                        <div class="info-item">
                            ...
                            <tr>
                                <td>
                                    <div class="product-cell">
                                        ...
                                        ?>
                                        <img src="<?php echo e($img); ?>" alt="<?php echo e($item->product_name); ?>" class="product-img" onerror="this.src='<?php echo e(asset('images/placeholder.jpg')); ?>'">
                                        <span class="product-name"><?php echo e($item->product_name); ?></span>
                                    </div>
                                </td>
                                <td><span class="qty-tag">x<?php echo e($item->quantity); ?></span></td>
                                <td style="text-align: right;">₹<?php echo e(number_format($item->price, 2)); ?></td>
                                <td style="text-align: right; font-weight: 500;">₹<?php echo e(number_format($item->subtotal, 2)); ?></td>
                            </tr>
                ...
                <div class="section">
                    <div class="totals">
                        ...
                        <div class="total-row">
                            <span>Shipping</span>
                            <span><?php echo e($order->shipping > 0 ? '₹'.number_format($order->shipping, 2) : 'FREE'); ?></span>
                        </div>
                        ...
                        <div class="total-row">
                            <span>Discount</span>
                            <span style="color: #28a745;">-₹<?php echo e(number_format($order->discount, 2)); ?></span>
                        </div>
                ...
                <div class="section">
                    <div class="delivery-box">
                        ...
                        <div class="delivery-text">
                            ...
                            ?>
                            <p><strong>Estimated Delivery:</strong> <?php echo e($deliveryDate->format('F d, Y')); ?></p>
                ...
                <div style="text-align: center; margin-top: 32px;">
                    <a href="<?php echo e(route('orders.show', $order)); ?>" class="btn">Track Order</a>
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-outline">Continue Shopping</a>
                </div>
            </div>

            <div class="footer">
                <p>Questions? Contact us at <?php echo e(config('mail.from.address')); ?></p>
                <p style="margin-top: 4px;"><?php echo e(config('app.name')); ?> — Crafted with love, adorned with gold.</p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/html/resources/views/emails/order-placed.blade.php ENDPATH**/ ?>