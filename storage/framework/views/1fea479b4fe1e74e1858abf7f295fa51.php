...
<div x-data="{
    ...
    <div class="space-y-4 mb-6">
        ...
        <div x-data="{ selected: <?php echo e(($selectedAddressId ?? 0) == $address->id ? 'true' : 'false'); ?>, editing: <?php echo e(old('full_name') && old('full_name') === $address->full_name ? 'true' : 'false' } } }"
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="font-medium text-[#2E1A12]"><?php echo e($address->full_name); ?></p>
                    <p class="text-sm text-gray-500 mt-1"><?php echo e($address->phone); ?></p>
                    <p class="text-sm text-gray-600 mt-1"><?php echo e($address->address_line); ?></p>
                    <p class="text-sm text-gray-600"><?php echo e($address->city); ?>, <?php echo e($address->state); ?> - <?php echo e($address->pincode); ?></p>
                    <p class="text-sm text-gray-500"><?php echo e($address->country); ?></p>
                </div>

                
                <div class="flex flex-col gap-2" @click.stop>
                    <button type="button"
                            @click="startEdit(<?php echo e($address->id); ?>, '<?php echo e(str_replace("'", "\\'", $address->full_name)); ?>', '<?php echo e(str_replace("'", "\\'", $address->phone)); ?>', '<?php echo e(str_replace("'", "\\'", $address->address_line)); ?>', '<?php echo e(str_replace("'", "\\'", $address->city)); ?>', '<?php echo e(str_replace("'", "\\'", $address->state)); ?>', '<?php echo e(str_replace("'", "\\'", $address->pincode)); ?>')"
            ...
            <input type="radio" name="address_id" value="<?php echo e($address->id); ?>" x-ref="radio_<?php echo e($address->id); ?>"
                   class="sr-only" <?php echo e(($selectedAddressId ?? 0) == $address->id ? 'checked' : ''); ?>>
        </div>
    ...
    <div x-show="addingNew" x-cloak x-transition class="mt-4">
        <div class="border border-[#C8A35D]/30 rounded-xl p-6 bg-[#FFFFF0]/30">
            ...
            <form action="<?php echo e(route('addresses.store')); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['address_line'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!Auth::check() || ($addresses->count() > 0 && !$addingNew)): ?>
...
<?php /**PATH /var/www/html/resources/views/pages/checkout/addresses/index.blade.php ENDPATH**/ ?>