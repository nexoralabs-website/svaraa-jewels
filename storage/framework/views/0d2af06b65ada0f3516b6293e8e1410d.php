...
<head>
    ...
    <title>Payment Reminder - <?php echo e($order->order_number); ?> | <?php echo e(config('app.name')); ?></title>
    <style>
    ...
    <div class="container">
        <div class="card">
            <div class="header">
                ...
                <p>Your order #<?php echo e($order->order_number); ?> is waiting for payment confirmation.</p>
            </div>
            <div class="body">
                <div class="info-grid">
                    <div class="info-item">
                ...
                <div style="text-align: center;">
                    <a href="<?php echo e($retryUrl ?? route('orders.show', $order)); ?>" class="btn">Complete Payment</a>
                </div>
            </div>
            <div class="footer">
...
<?php /**PATH /var/www/html/resources/views/emails/payment-retry.blade.php ENDPATH**/ ?>