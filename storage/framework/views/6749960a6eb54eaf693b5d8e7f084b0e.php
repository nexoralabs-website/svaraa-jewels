    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mt-0">
            ...
            <div class="signature-grid">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $signaturePieces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $piece): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="signature-card <?php echo e($piece['colSpan']); ?> <?php echo e($piece['rowSpan']); ?> p-6 jewelry-detail" style="animation-delay: <?php echo e($loop->index * 150); ?>ms;">
                        <div class="absolute top-4 right-4">
                            <span class="rounded-full bg-[#F5EBDD] px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-[#6E0F12]"><?php echo e($piece['tag']); ?></span>
                        </div>
                        ...
                        <h3 class="text-xl font-semibold text-[#2E1A12] text-center" style="font-family: 'Playfair Display', serif;"><?php echo e($piece['name']); ?></h3>
                        <p class="mt-2 text-sm text-[#7B6755] text-center"><?php echo e($piece['description']); ?></p>
                        
                        <div class="mt-4 flex justify-center">
                            <a href="<?php echo e(route('products.index')); ?>" class="cta-pill rounded-full bg-[#6E0F12] px-5 py-2 text-sm font-semibold text-white hover:bg-[#4f0b0e] luxury-cta">
                                View Details
                            </a>
                        </div>
                    </div>
        ...
        <div class="mt-24 grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div class="section-shell section-reveal p-8 md:p-10">
                ...
                <div class="no-scrollbar mt-8 flex gap-5 overflow-x-auto pb-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $piece): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="product-card card-tilt group min-w-[260px] max-w-[260px] rounded-[1.5rem] border border-[#e8dccb] bg-[#fffdf9] p-5 shadow-sm product-premium" style="animation-delay: <?php echo e($loop->index * 120); ?>ms;">
                            <div class="flex items-center justify-between">
                                <span class="rounded-full bg-[#F5EBDD] px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-[#6E0F12]"><?php echo e($piece['badge']); ?></span>
                            ...
                            <h4 class="mt-4 text-xl font-semibold text-[#2E1A12]" style="font-family: 'Playfair Display', serif;"><?php echo e($piece['name']); ?></h4>
                            <p class="mt-2 text-sm text-[#7B6755]"><?php echo e($piece['note']); ?></p>
                            <div class="product-cta mt-5 flex items-center justify-between">
                                <span class="text-lg font-semibold text-[#6E0F12]"><?php echo e($piece['price']); ?></span>
                                <div class="flex gap-2">
                                    <a href="<?php echo e(route('products.index')); ?>" class="icon-action rounded-full border border-[#e8dccb] bg-white px-3 py-2 text-sm font-semibold text-[#6E0F12] hover:bg-[#F5EBDD]">Quick view</a>
                                    <a href="<?php echo e(route('products.index')); ?>" class="wishlist-badge rounded-full border border-[#e8dccb] bg-white px-3 py-2 text-sm font-semibold text-[#6E0F12] hover:bg-[#F5EBDD]">♡</a>
                                </div>
                            </div>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="grid gap-6">
                <div class="section-shell section-reveal p-8 md:p-10">
                    ...
                    <div class="mt-6 flex flex-wrap gap-3">
                        <a href="<?php echo e(route('about')); ?>" class="cta-pill rounded-full bg-[#6E0F12] px-5 py-3 text-sm font-semibold text-white hover:bg-[#4f0b0e] luxury-cta">Explore Designs</a>
        ...
        <div class="mt-24">
            ...
            <div class="instagram-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 1; $i <= 8; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="https://instagram.com/svaraa.jewels_" target="_blank" class="instagram-item" style="animation-delay: <?php echo e(($i - 1) * 80); ?>ms;">
...
<?php /**PATH /var/www/html/resources/views/components/featured-categories.blade.php ENDPATH**/ ?>