    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <nav class="mb-8 text-sm">
            <ol class="flex items-center space-x-2">
                <li><a href="<?php echo e(route('home')); ?>" class="text-[#7B6755] hover:text-[#6E0F12] transition-colors">Home</a></li>
                <li><span class="text-[#7B6755]">/</span></li>
                <li><a href="<?php echo e(route('products.index')); ?>" class="text-[#7B6755] hover:text-[#6E0F12] transition-colors">Products</a></li>
                <li><span class="text-[#7B6755]">/</span></li>
                <li class="text-[#2E1A12]"><?php echo e($product->name); ?></li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-1/2">
                <div class="card-premium p-4">
                    <div class="aspect-square bg-[#E8DCCB] rounded-lg flex items-center justify-center mb-4">
                        <img src="<?php echo e($product->thumbnail_url); ?>" alt="<?php echo e($product->name); ?>" id="mainImage" class="w-full h-full object-cover rounded-lg" />
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->images->count() > 0): ?>
                        <div class="grid grid-cols-4 gap-3">
                            <div class="aspect-square bg-[#E8DCCB] rounded-lg overflow-hidden cursor-pointer border-2 border-[#C8A35D]">
                                <img src="<?php echo e($product->thumbnail_url); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover" onclick="document.getElementById('mainImage').src='<?php echo e($product->thumbnail_url); ?>'" />
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="aspect-square bg-[#E8DCCB] rounded-lg overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#C8A35D] transition-colors">
                                    <img src="<?php echo e($image->image_url); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover" onclick="document.getElementById('mainImage').src='<?php echo e($image->image_url); ?>'" />
                                </div>
            ...
            <!-- Product Info -->
            <div class="lg:w-1/2">
                <p class="text-[#C8A35D] font-medium mb-2"><?php echo e($product->category?->name); ?></p>
                <h1 class="text-3xl md:text-4xl font-bold text-[#2E1A12] mb-4" style="font-family: 'Playfair Display', serif;"><?php echo e($product->name); ?></h1>
                <div class="text-3xl font-bold text-[#6E0F12] mb-6">₹<?php echo e(number_format($product->price, 0)); ?></div>

                <!-- Product Details -->
                <div class="mb-8 space-y-4">
                    <div class="flex items-center gap-4">
                        <span class="text-[#7B6755] w-24">Purity:</span>
                        <span class="text-[#2E1A12] font-medium"><?php echo e($product->purity); ?></span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->weight): ?>
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-[#2E1A12] font-medium"><?php echo e($product->weight); ?> g</span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-[#7B6755] leading-relaxed"><?php echo e($product->description); ?></p>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.products.card','data' => ['product' => $relatedProduct]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/pages/products/show.blade.php ENDPATH**/ ?>