<footer class="bg-[#2E1A12] py-12 text-[#E8DCCB]">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <div>
                    ...
                    <ul class="mt-4 space-y-3 text-sm text-[#f4e2c2]">
                        <li><a href="<?php echo e(route('home')); ?>" class="footer-link transition hover:text-white">Home</a></li>
                        <li><a href="<?php echo e(route('products.index')); ?>" class="footer-link transition hover:text-white">Shop</a></li>
                        <li><a href="<?php echo e(route('about')); ?>" class="footer-link transition hover:text-white">About</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-sm font-semibold uppercase tracking-[0.25em] text-[#C8A35D]">Support</h4>
                    <ul class="mt-4 space-y-3 text-sm text-[#f4e2c2]">
                        <li><a href="<?php echo e(route('contact')); ?>" class="footer-link transition hover:text-white">Contact</a></li>
                        <li><a href="<?php echo e(route('shipping-policy')); ?>" class="footer-link transition hover:text-white">Shipping</a></li>
                        <li><a href="<?php echo e(route('refund-policy')); ?>" class="footer-link transition hover:text-white">Returns</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-sm font-semibold uppercase tracking-[0.25em] text-[#C8A35D]">Policies</h4>
                    <ul class="mt-4 space-y-3 text-sm text-[#f4e2c2]">
                        <li><a href="<?php echo e(route('terms')); ?>" class="footer-link transition hover:text-white">Terms & Conditions</a></li>
                        <li><a href="<?php echo e(route('privacy-policy')); ?>" class="footer-link transition hover:text-white">Privacy Policy</a></li>
                        <li><a href="<?php echo e(route('shipping-policy')); ?>" class="footer-link transition hover:text-white">Shipping Policy</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="mt-10 border-t border-[#C8A35D]/30 pt-6 text-center text-sm text-[#f4e2c2]">
            © <?php echo e(date('Y')); ?> Svaraa Jewels. All rights reserved.
        </div>
    </div>
</footer>
