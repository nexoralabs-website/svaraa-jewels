        ...
        <div class="flex flex-col sm:flex-row justify-between gap-2">
            <div>
                <p class="text-xs text-gray-500 uppercase tracking-widest mb-1">
                    <?php echo e($item->product->category->name ?? 'Jewelry'); ?>
        ...
        <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div 
                ...
                x-data="{
                    ...
                    stock: <?php echo e($item->product->stock ?? 99); ?>,
                    updating: false,
                    async changeQty(delta) {
                        ...
                        try {
                            await $store.cart.update(<?php echo e($item->product->id); ?>, newQty);
                        } catch (e) {
                            this.quantity -= delta;
                        }
                        this.updating = false;
                    ...
                    async setQty() {
                        ...
                        this.updating = true;
                        try {
                            await $store.cart.update(<?php echo e($item->product->id); ?>, this.quantity);
                        } catch (e) {
                            this.quantity = <?php echo e($item->quantity); ?>;
                        }
                        this.updating = false;
            ...
            <div class="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-end">
                <div class="text-sm">
                    ...
                    <span class="font-medium text-gray-900">&#8377;<?php echo e(number_format($item->product->price * $item->quantity, 2)); ?></span>
                </div>
                
                <button 
                    type="button" 
                    @click="$store.cart.remove(<?php echo e($item->product->id); ?>)"
...
<?php /**PATH /var/www/html/resources/views/components/cart/item.blade.php ENDPATH**/ ?>